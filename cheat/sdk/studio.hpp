...
struct mstudiohitboxset_t {
	...
	mstudiobbox_t* GetHitbox( int index ) const {
...
struct studiohdr_t {
	...
	mstudiohitboxset_t* GetHitboxSet( int index ) const {
...
public:
	const model_t* GetModel( int modelindex ) {
		return util::get_virtual_function< const model_t* ( __thiscall* )( void* , int ) >( this , 1 )( this , modelindex );
	}

	int GetModelIndex( const char* model ) {
		return util::get_virtual_function< int( __thiscall* )( void* , const char* ) >( this , 2 )( this , model );
	}

	int GetModelFrameCount( const model_t* model ) {
		return util::get_virtual_function< int( __thiscall* )( void* , const model_t* ) >( this , 7 )( this , model );
	}

	studiohdr_t* GetStudioModel( const model_t* model ) {
		return util::get_virtual_function< studiohdr_t* ( __thiscall* )( void* , const model_t* ) >( this , 32 )( this , model );
	}

	const model_t* FindOrLoadModel( const char* name ) {
		return util::get_virtual_function< const model_t* ( __thiscall* )( void* , const char* ) >( this , 43 )( this , name );
	}
};
